...
Это форк оригинального плагина IP v5.3.1.1, обновлённый для совместимости с серверами на базе **Purpur/Paper 26.2**. Оригинальный плагин поддерживал Spigot 1.16–1.20.4 — этот форк добавляет поддержку новой платформы.
